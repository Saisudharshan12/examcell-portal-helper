      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <div className={`transition-opacity duration-700 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'}`}>
          <div className="mb-10 flex justify-center">
            <img src="/lovable-uploads/e940d628-680d-49fd-9c3e-600410cbbfd8.png" alt="Amrita School of Engineering" className="h-20 animate-fade-in object-scale-down" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-12 max-w-3xl mx-auto">
            <div className="flex flex-col items-center justify-center w-56 h-56 rounded-full border-2 border-red-500 bg-white p-8 shadow-sm hover:shadow-lg transition-all animate-scale-in hover:scale-110" style={{
            animationDelay: "0.2s"
          }}>
              ...
              <Link to="/faculty-login" className="w-full bg-brand-magenta hover:bg-brand-dark text-white py-2 px-4 rounded text-center transition-colors">
                Login
              </Link>
            </div>
            ...
            animationDelay: "0.3s"
              ...
              <Link to="/admin-login" className="w-full bg-brand-magenta hover:bg-brand-dark text-white py-2 px-4 rounded text-center transition-colors">
                Login
              </Link>
            </div>
          </div>

...
const FacultyDashboard = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex items-center space-x-2 px-6 py-2 bg-white border-b">
        <Link to="/faculty-dashboard?role=mentor" className="text-sm px-4 py-1 rounded-full bg-brand-magenta text-white">
          Course Mentor
        </Link>
        <Link to="/faculty-dashboard?role=moderator" className="text-sm px-4 py-1 rounded-full border border-gray-300 text-gray-700 hover:bg-gray-100 transition-colors">
          Faculty Moderator
        </Link>
      </div>
      
      <main className="flex-1 container mx-auto py-6 px-4">
        <div className="mb-6 bg-amber-50 border border-amber-200 rounded-lg p-4 animate-fade-in" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white border rounded-lg shadow-sm animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
